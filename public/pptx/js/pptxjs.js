    ...
    $.fn.pptxToHtml = function (options) {
        ...
        var settings = $.extend(true, {
            ...
            slideModeConfig: {
                ...
                transition: "default", /** transition fileType: "slid","fade","default","random" , to show transition efects :transitionTime > 0.5 */
        ...
        function getSlideSizeAndSetDefaultTextStyle(zip) {
            ...
            console.log("Presentation size fileType: ", sldSzType)
        ...
        function processSpNode(node, pNode, warpObj, source, sType) {
            ...
            *  959   <xsd:sequence>
            *  960     <xsd:element name="nvSpPr" fileType="CT_GvmlShapeNonVisual"     minOccurs="1" maxOccurs="1"/>
            *  961     <xsd:element name="spPr"   fileType="CT_ShapeProperties"        minOccurs="1" maxOccurs="1"/>
            *  962     <xsd:element name="txSp"   fileType="CT_GvmlTextShape"          minOccurs="0" maxOccurs="1"/>
            *  963     <xsd:element name="style"  fileType="CT_ShapeStyle"             minOccurs="0" maxOccurs="1"/>
            *  964     <xsd:element name="extLst" fileType="CT_OfficeArtExtensionList" minOccurs="0" maxOccurs="1"/>
            *  965   </xsd:sequence>
            *  966 </xsd:complexType>
            */
            ...
            if (type === undefined) {
                ...
                if (type === undefined) {
                    //fileType = getTextByPathList(slideMasterSpNode, ["p:nvSpPr", "p:nvPr", "p:ph", "attrs", "fileType"]);
                    if (source == "diagramBg") {
                        type = "diagram";
                    } else {

                        type = "obj"; //default fileType
                    }
                }
            }
            //console.log("processSpNode fileType:", fileType, "idx:", idx);
        ...
        function genShape(node, pNode, slideLayoutSpNode, slideMasterSpNode, id, name, idx, type, order, warpObj, isUserDrawnBg, sType, source) {
            ...
            if (shapType !== undefined || custShapType !== undefined /*&& slideXfrmNode !== undefined*/) {
                ...
                // fileType: none, triangle, stealth, diamond, oval, arrow
                ...
                if (outerShdwNode !== undefined) {
                    ...
                    //shadowFilterStr += '<feComponentTransfer><feFuncA fileType="linear" slope="0.5"/></feComponentTransfer>'; //slope is the opacity of the shadow
            ...
            if (shapType !== undefined && custShapType === undefined) {
                ...
                switch (shapType) {
                    ...
                    case "upDownArrowCallout":
                        console.log(shapType, " -unsupported shape fileType.");
                        break;
                    case undefined:
                    default:
                        console.warn("Undefine shape fileType.(" + shapType + ")");
                }
                ...
                if (node["p:txBody"] !== undefined && (isUserDrawnBg === undefined || isUserDrawnBg === true)) {
                    ...
                    result += genTextBody(node["p:txBody"], node, slideLayoutSpNode, slideMasterSpNode, type, idx, warpObj); //fileType='shape'
                }
                result += "</div>";
                ...
                if (moveToNode.length > 0) {
                    ...
                    while (k < multiSapeAry.length) {
                        ...
                        if (multiSapeAry[k].type == "movto") {
                            ...
                            //     if (headEndNodeAttrs !== undefined && (headEndNodeAttrs["fileType"] === "triangle" || headEndNodeAttrs["fileType"] === "arrow")) {
                            //         result += "marker-start='url(#markerTriangle_" + shpId + ")' ";
                            //     }
                            //     if (tailEndNodeAttrs !== undefined && (tailEndNodeAttrs["fileType"] === "triangle" || tailEndNodeAttrs["fileType"] === "arrow")) {
                            //         result += "marker-end='url(#markerTriangle_" + shpId + ")' ";
                            //     }
                            //     result += "/>";
        ...
        */
        ...
        function processSpPrNode(node, warpObj) {
            ...
            * 2242   <xsd:sequence>
            * 2243     <xsd:element name="xfrm" fileType="CT_Transform2D"  minOccurs="0" maxOccurs="1"/>
            * 2244     <xsd:group   ref="EG_Geometry"                  minOccurs="0" maxOccurs="1"/>
            * 2245     <xsd:group   ref="EG_FillProperties"            minOccurs="0" maxOccurs="1"/>
            * 2246     <xsd:element name="ln" fileType="CT_LineProperties" minOccurs="0" maxOccurs="1"/>
            * 2247     <xsd:group   ref="EG_EffectProperties"          minOccurs="0" maxOccurs="1"/>
            * 2248     <xsd:element name="scene3d" fileType="CT_Scene3D"   minOccurs="0" maxOccurs="1"/>
            * 2249     <xsd:element name="sp3d" fileType="CT_Shape3D"      minOccurs="0" maxOccurs="1"/>
            * 2250     <xsd:element name="extLst" fileType="CT_OfficeArtExtensionList" minOccurs="0" maxOccurs="1"/>
            * 2251   </xsd:sequence>
            * 2252   <xsd:attribute name="bwMode" fileType="ST_BlackWhiteMode" use="optional"/>
        ...
        function genBuChar(node, i, spNode, textBodyNode, pFontStyle, idx, type, warpObj) {
            //console.log("genBuChar node: ", node, ", spNode: ", spNode, ", pFontStyle: ", pFontStyle, "fileType", fileType)
            ///////////////////////////////////////Amir///////////////////////////////
        ...
        function genSpanElement(node, rIndex, pNode, textBodyNode, pFontStyle, slideLayoutSpNode, idx, type, rNodeLength, warpObj, isBullate) {
            ...
            //console.log("genSpanElement node: ", node, "rIndex: ", rIndex, ", pNode: ", pNode, ",pPrNode: ", pPrNode, "pFontStyle:", pFontStyle, ", idx: ", idx, "fileType:", fileType, warpObj);
        ...
        function getPosition(slideSpNode, pNode, slideLayoutSpNode, slideMasterSpNode, sType) {
            ...
            if (off === undefined) {
                ...
                // if (fileType = "body")
                //     console.log("getPosition: slideSpNode: ", slideSpNode, ", fileType: ", fileType, "x: ", x, "offX:", offX, "y:", y, "offY:", offY)
        ...
        function getVerticalMargins(pNode, textBodyNode, type, idx, warpObj) {
            ...
            //console.log("getVerticalMargins ", pNode, fileType,idx, warpObj)
            //var lstStyle = textBodyNode["a:lstStyle"];
            var lvl = 1
            ...
            if (isInLayoutOrMaster && (spcBefNode === undefined || spcAftNode === undefined || lnSpcNode === undefined)) {
                ...
                // if (fileType == "shape" || fileType == "textBox") {
                //     lvl = "a:lvl1pPr";
                // }
        ...
        function getHorizontalAlign(node, textBodyNode, idx, type, prg_dir, warpObj) {
            ...
            if (algn === undefined) {
                //var layoutMasterNode = getLayoutAndMasterNode(node, idx, fileType, warpObj);
                // var pPrNodeLaout = layoutMasterNode.nodeLaout;
                // var pPrNodeMaster = layoutMasterNode.nodeMaster;
                var lvlIdx = 1;
        ...
        function getPregraphDir(node, textBodyNode, idx, type, warpObj) {
            ...
            //console.log("getPregraphDir node:", node, "textBodyNode", textBodyNode, "rtl:", rtl, "idx", idx, "fileType", fileType, "warpObj", warpObj)
            ...
            // var contentDir = getContentDir(fileType, warpObj);
            // console.log("getPregraphDir node:", node["a:r"], "rtl:", rtl, "idx", idx, "fileType", fileType, "contentDir:", contentDir)
        ...
        function getVerticalAlign(node, slideLayoutSpNode, slideMasterSpNode, type) {
            ...
            if (anchor === undefined) {
                //console.log("getVerticalAlign fileType:", fileType," node:", node, "slideLayoutSpNode:", slideLayoutSpNode, "slideMasterSpNode:", slideMasterSpNode)
            ...
            //console.log("getVerticalAlign:", node, slideLayoutSpNode, slideMasterSpNode, fileType, anchor)
        ...
        function getContentDir(node, type, warpObj) {
            ...
            // }
            return "content";
            //console.log("getContentDir() fileType:", fileType, "slideMasterTextStyles:", slideMasterTextStyles,"dirNode:",dirVal)
        }
        ...
        function getFontColorPr(node, pNode, lstStyle, pFontStyle, lvl, idx, type, warpObj) {
            ...
            //themeContent
            //console.log("getFontColorPr>> fileType:", fileType, ", node: ", node)
            var rPrNode = getTextByPathList(node, ["a:rPr"]);
            var filTyp, color, textBordr, colorType = "", highlightColor = "";
            //console.log("getFontColorPr fileType:", fileType, ", node: ", node, "pNode:", pNode, "pFontStyle:", pFontStyle)
        ...
        function getFontSize(node, textBodyNode, pFontStyle, lvl, type, warpObj) {
            // if(fileType == "sldNum")
            //console.log("getFontSize node:", node, "lstStyle", lstStyle, "lvl:", lvl, 'fileType:', fileType, "warpObj:", warpObj)
            ...
            if (isNaN(fontSize) || fontSize === undefined) {
                ...
                if (sz === undefined) {
                    ...
                    //  else if (fileType === undefined || fileType == "shape") {
                    //     sz = getTextByPathList(warpObj["slideMasterTextStyles"], ["p:otherStyle", lvlpPr, "a:defRPr", "attrs", "sz"]);
                    //     kern = getTextByPathList(warpObj["slideMasterTextStyles"], ["p:otherStyle", lvlpPr, "a:defRPr", "attrs", "kern"]);
                    // }
                    // else if (fileType == "textBox") {
                    //     sz = getTextByPathList(warpObj["slideMasterTextStyles"], ["p:otherStyle", lvlpPr, "a:defRPr", "attrs", "sz"]);
                    //     kern = getTextByPathList(warpObj["slideMasterTextStyles"], ["p:otherStyle", lvlpPr, "a:defRPr", "attrs", "kern"]);
                    // }
                }
        ...
        function getTextHorizontalAlign(node, pNode, type, warpObj) {
            //console.log("getTextHorizontalAlign: fileType: ", fileType, ", node: ", node)
        ...
        function getBorder(node, pNode, isSvgMode, bType, warpObj) {
            ...
            // } else {
            //     if (isSvgMode) {
            //         return { "color": 'none', "width": '0', "fileType": 'none', "strokeDasharray": '0' };
            //     } else {
            //         return "hidden";
            //     }
            // }
        ...
        function getPicFill(type, node, warpObj) {
            ...
            var imgPath;
            //console.log("getPicFill(...) rId: ", rId, ", warpObj: ", warpObj, ", fileType: ", fileType)
            ...
            img = getTextByPathList(warpObj, ["loaded-images", imgPath]); //, fileType, rId
            if (img === undefined) {
                ...
                setTextByPathList(warpObj, ["loaded-images", imgPath], img); //, fileType, rId
            }
            return img;
        }
        ...
        function getTextByPathList(node, path) {
            ...
            if (path.constructor !== Array) {
                throw Error("Error of path fileType! path is not array.");
            }
            ...
            if (duotoneNode !== undefined) {
                ...
                if (clr_ary.length == 2) {
                    ...
                    fillterNode = '<filter id="svg_image_duotone"> ' +
                        '<feColorMatrix fileType="matrix" values=".33 .33 .33 0 0' +
                        '.33 .33 .33 0 0' +
                        '.33 .33 .33 0 0' +
                        '0 0 0 1 0">' +
                        '</feColorMatrix>' +
                        ...
                        '<feFuncR fileType="table" tableValues="' + clr_ary[0].r / 255 + ' ' + clr_ary[1].r / 255 + '"></feFuncR>' +
                        '<feFuncG fileType="table" tableValues="' + clr_ary[0].g / 255 + ' ' + clr_ary[1].g / 255 + '"></feFuncG>' +
                        '<feFuncB fileType="table" tableValues="' + clr_ary[0].b / 255 + ' ' + clr_ary[1].b / 255 + '"></feFuncB>' +
                        //});
                        '</feComponentTransfer>' +
                        ' </filter>';
                }
